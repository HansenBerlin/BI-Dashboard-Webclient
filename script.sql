create table buy_aggregates_info
(
    id                     int    null,
    score                  double null,
    scLivingspaceSqmPrice  int    null,
    scLotareaSqmPrice      double null,
    scPurchasePrice        double null,
    scPricetrend           double null,
    scCondition            double null,
    scFiring_type          double null,
